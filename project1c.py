...
using user input and the score is kept inside the try
block and except block to handle the error.
For Grade and Percentage calculation function is
written with name calcthegrade.
